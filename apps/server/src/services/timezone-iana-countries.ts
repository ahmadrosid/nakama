/**
 * IANA country assignments used when `/usr/share/zoneinfo` is missing.
 * Rows are countryCode, tab, zoneName from IANA zone.tab (public domain).
 */
export const FALLBACK_ZONE_TAB = `AD	Europe/Andorra
AE	Asia/Dubai
AF	Asia/Kabul
AG	America/Antigua
AI	America/Anguilla
...
/** ICU / CLDR names that differ from the current IANA zone.tab id. */
export const ICU_TIMEZONE_ALIASES: Readonly<Record<string, string>> = {
