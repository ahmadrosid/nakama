...
agent-browser --session "$SESSION" screenshot "$SCREENSHOT_DIR/setup-step-account.png"
...
agent-browser --session "$SESSION" snapshot -i >/dev/null
agent-browser --session "$SESSION" screenshot "$SCREENSHOT_DIR/setup-step-organization.png"
...
agent-browser --session "$SESSION" snapshot -i >/dev/null
agent-browser --session "$SESSION" screenshot "$SCREENSHOT_DIR/setup-step-provider.png"
