...
**Control center → Integrations → Context savings** carries the toggle and the numbers. Changing it is an org-admin action, because it changes what every session in the org does.
