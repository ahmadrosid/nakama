...
2. The owning profile's Telegram worker is running
...
Generate a new pairing code from **Agent → profile → Channels → Telegram** and send it to the bot in a private chat.
