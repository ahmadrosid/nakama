...
1. Open **Control center → Integrations → Notifications**
...
![Create a Telegram notification destination from Control center → Integrations → Notifications](/screenshots/telegram-notifications.png)
...
From **Control center → Integrations → Notifications**, Nakama can create Telegram webhook destinations for a group or a forum topic.
