...
1. Add the server with its URL and no headers. **Test connection** answers "This server
   signs in with a browser" in amber rather than a red error, and the save button becomes
   **Add and sign in**
2. A dialog offers the provider's sign-in page. Click it, and the page opens in a new tab
