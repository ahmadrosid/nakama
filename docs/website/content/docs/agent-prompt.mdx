...
- User context from `USER.md`, when available (filled in at setup step 4 or from **Control center → Workspace → Settings**)
- The user's timezone
