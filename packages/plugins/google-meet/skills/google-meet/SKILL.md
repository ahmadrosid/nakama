---
name: google-meet
description: Join an explicitly supplied Google Meet URL, transcribe meeting audio, read the transcript, or leave a meeting.
---
...
1. Call `plugin_google_meet__join` with the exact meeting URL and maximum duration (1–55 minutes, default 30).
